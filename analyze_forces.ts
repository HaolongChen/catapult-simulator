...
console.log(
  `  Gravity: [${forces.gravity[0].toFixed(2)}, ${forces.gravity[1].toFixed(2)}, ${forces.gravity[2].toFixed(2)}] N`,
)
console.log(
  `  Drag: [${forces.drag[0].toFixed(2)}, ${forces.drag[1].toFixed(2)}, ${forces.drag[2].toFixed(2)}] N`,
)
console.log(
  `  Magnus: [${forces.magnus[0].toFixed(2)}, ${forces.magnus[1].toFixed(2)}, ${forces.magnus[2].toFixed(2)}] N`,
)
console.log(
  `  Tension: [${forces.tension[0].toFixed(2)}, ${forces.tension[1].toFixed(2)}, ${forces.tension[2].toFixed(2)}] N`,
)
console.log(
  `  Total: [${forces.total[0].toFixed(2)}, ${forces.total[1].toFixed(2)}, ${forces.total[2].toFixed(2)}] N`,
)

console.log('\nArm torques:')
console.log(
  `  Pivot friction: ${forces.armTorques.pivotFriction.toFixed(2)} N⋅m`,
)
...
console.log(
  `  [${derivative.velocity[0].toFixed(2)}, ${derivative.velocity[1].toFixed(2)}, ${derivative.velocity[2].toFixed(2)}] m/s²`,
)
...
console.log(
  `  [${expectedAccel[0].toFixed(2)}, ${expectedAccel[1].toFixed(2)}, ${expectedAccel[2].toFixed(2)}] m/s²`,
)
...
console.log(
  `  [${derivative.slingVelocities[0].toFixed(2)}, ${derivative.slingVelocities[1].toFixed(2)}] m/s²`,
)
