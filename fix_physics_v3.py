...
# 1. Ensure mass floor is 1.0 in derivatives (it's in constants.ts too, but let's be sure)
# Actually it's already using PHYSICS_CONSTANTS.MIN_PARTICLE_MASS_BASE

# 2. Rewrite solveSchur WITHOUT scaling but with consistent regularization
